...
earshot is a Jekyll theme designed with something very specific in mind: to be a simple and elegant personal landing page that can be easily deployed to [GitHub Pages](https://pages.github.com/).

## How to use earshot

1. Start by [installing Bundler](http://bundler.io) `gem install bundler`
2. [Fork the earshot repository](https://github.com/excentris/earshot/fork)
3. Then run `bundle install` to get [Jekyll](http://jekyllrb.com) and all the dependencies.
4. Clone the repository you just forked: `git clone https://github.com/YOUR-USER/earshot`
